...
public class Activity_Add_Players extends AppCompatActivity {
    ...
    private void performAction(ImageView imageView,int selectedBoxPosition){
        ...
        if (playerTurn == 1){
            ...
            if (checkPlayerWin()){
                WinDialog winDialog =new WinDialog(Activity_Add_Players.this,playerOneName.getText().toString()+"has won the match",Activity_Add_Players.this);
                winDialog.setCancelable(false);
                winDialog.show();
            }
            else if (totalSelectedBoxes == 9){
                WinDialog winDialog =new WinDialog(Activity_Add_Players.this,"Its a draw",Activity_Add_Players.this);
                winDialog.setCancelable(false);
                winDialog.show();
            }
            else {
            ...
            if (checkPlayerWin()){
                WinDialog winDialog =new WinDialog(Activity_Add_Players.this,playerTwoName.getText().toString()+"has won the match",Activity_Add_Players.this);
                winDialog.setCancelable(false);
                winDialog.show();
            }
